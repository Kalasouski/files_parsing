...
class CsvParserTest {
    ...
    void givenGetTransactionsListMethodWhenPassingCsvStringThenReturnsCorrespondingList(String csvStr,
        ...
        assertEquals(expected, new CsvParser().getTransactionsList(csvStr));
    }
        ...
        return Stream.of(
                arguments(
                        """
                                ...
                                1619674154,1c22f114-8251-404e-8c3f-73b70bd0ec80,a00a7fb0-3a72-454d-865d-8f6818f8dd62,34623,usd,success
                                1619676321,fb3e82e1-8608-41cd-9148-b604f4f1c5a4,bebb0888-2a6f-4f38-b8e7-800a2a3145e8,24843,usd,rejected
                                """,
                        Arrays.asList(
